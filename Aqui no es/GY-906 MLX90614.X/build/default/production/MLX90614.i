...
float MLX90614_readObjectTempC(void){
    return ((MLX90614_ReadReg(0x07)* 0.02) - 273.15);
}
float MLX90614_readAmbientTempC(void){
    return ((MLX90614_ReadReg(0x06)* 0.02) - 273.15);
}

float MLX90614_readEmissivity(void){
    float reg;
    reg = MLX90614_ReadReg(0x24);
    return (reg / 65535.0);
}
# 73 "MLX90614.c"
void MLX90614_WriteReg(uint8_t reg, uint16_t val){
...
void MLX90614_writeEmissivity(float emissivity){
    ...
    MLX90614_WriteReg(0x24,0);
    _delay((unsigned long)((10)*(32000000UL/4000.0)));
    printf("0x%x\n",ereg);
    MLX90614_WriteReg(0x24,ereg);
    _delay((unsigned long)((10)*(32000000UL/4000.0)));
