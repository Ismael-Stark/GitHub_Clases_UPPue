...
# 2 "<built-in>" 2
# 1 "../Timers.X/interrupt.c" 2
# 1 "../Timers.X/interrupt.h" 1
...
# 5 "../Timers.X/interrupt.h" 2
# 40 "../Timers.X/interrupt.h"
# 1 "../Timers.X/main.h" 1
...
# 7 "../Timers.X/main.h" 2
# 40 "../Timers.X/interrupt.h" 2

# 1 "../Timers.X/misVar.h" 1
# 11 "../Timers.X/misVar.h"
uint8_t counts = 0,countsAnterior;
uint8_t recepcionRX=0;
# 41 "../Timers.X/interrupt.h" 2
...
# 1 "../Timers.X/Timer0.h" 1
# 12 "../Timers.X/Timer0.h"
    typedef enum{
        T0Poscaler_div1 = 0,
        T0Poscaler_div2,
        T0Poscaler_div3,
...
# 2 "../Timers.X/interrupt.c" 2

# 1 "../Timers.X/Timer5.h" 1
# 11 "../Timers.X/Timer5.h"
    typedef enum{
        T5PrescDiv1 = 0,
        T5PrescDiv2,
        T5PrescDiv4,
    ...
    uint16_t Timer5_get();
# 3 "../Timers.X/interrupt.c" 2

# 1 "../Timers.X/servo.h" 1
# 14 "../Timers.X/servo.h"
    ...
    uint8_t valTIMER0;
# 4 "../Timers.X/interrupt.c" 2


# 1 "../Timers.X/uart.h" 1
# 11 "../Timers.X/uart.h"
void serial_init(uint32_t baudios);
void serial_Interrupt_init(uint32_t baudios);

void uart_tx(uint8_t dato);
void uart_send_string(uint8_t *dato);
uint8_t uart_rx();
# 6 "../Timers.X/interrupt.c" 2

# 1 "../Timers.X/MultiServo.h" 1
# 27 "../Timers.X/MultiServo.h"
