...
void Send_D7_D4(int8 address,int8 nibble){
   ...
   if((nibble & 8)==8) datos= datos|128; else datos = datos&~128;
      _delay((unsigned long)((60)*(10000000/4000000.0)));
   if(address)
      datos= datos |1;
   else
     datos = datos &~1;
   ...
   Write_PCF( datos | 4);
   _delay((unsigned long)((2)*(10000000/4000000.0)));
   Write_PCF( datos & ~4);
}
...
void lcd_init(void){
   ...
   I2C1_Write1ByteRegister(32|(7),0,0);

   _delay((unsigned long)((35)*(10000000/4000.0)));
