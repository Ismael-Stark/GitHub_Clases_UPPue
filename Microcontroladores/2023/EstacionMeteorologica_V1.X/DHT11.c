#include "DHT11.h"
    #define dht11T  TRISDbits.TRISD3    //para poner al pin como E/s
    #define dht11L  LATDbits.LATD3      //para activar al sensor
    #define dht11P  PORTDbits.RD3       //para leer el sensor
    #define dht11_noAnalog  ANSELDbits.ANSELD3 = 0// ANSELB = 0;
    #define dht11_pullUp    WPUDbits.WPUD3 = 1// activar pullup;
