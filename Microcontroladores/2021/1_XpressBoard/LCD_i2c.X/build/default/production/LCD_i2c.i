...
# 50 "./DEVICE_CONFIG.h" 2

# 1 "./I2C.h" 1
# 51 "./DEVICE_CONFIG.h" 2

# 1 "./LCD_i2c.h" 1
# 52 "./DEVICE_CONFIG.h" 2
...
void lcd_init(void){
   ...
   _delay((unsigned long)((35)*(8000000UL/4000.0)));
