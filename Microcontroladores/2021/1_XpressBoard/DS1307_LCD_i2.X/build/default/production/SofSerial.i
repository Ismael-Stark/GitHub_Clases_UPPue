...
void SoftWareUart_Init()
{
  ...
  TRISCbits.TRISC6=1;
  LATCbits.LATC5=1;
 _delay((unsigned long)((((1000000/9600)))*(8000000/4000000.0)));
}
...
void Software_UART_Write(unsigned char Data)
{
  ...
  _delay((unsigned long)(((((1000000/9600)) - (4*16/32)))*(8000000/4000000.0)));
  }
  LATCbits.LATC5 = 1;
  _delay((unsigned long)((((1000000/9600)))*(8000000/4000000.0)));
}
...
unsigned char Software_UART_Read ()
{
 ...
 while(PORTCbits.RC6==1);
  _delay((unsigned long)(((((1000000/9600))/2))*(8000000/4000000.0)));
  for(mask=0x01;mask!=0;mask=mask<<1)
  {
    _delay((unsigned long)(((((1000000/9600)) - (4*18/32)))*(8000000/4000000.0)));
