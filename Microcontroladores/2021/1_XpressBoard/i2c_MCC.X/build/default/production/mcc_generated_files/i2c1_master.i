...
static void I2C1_SetCallback(i2c1_callbackIndex_t idx, i2c1_callback_t cb, void *ptr)
{
    ...
    else
    {
        ...
        I2C1_Status.callbackPayload[idx] = (0);
    }
}
