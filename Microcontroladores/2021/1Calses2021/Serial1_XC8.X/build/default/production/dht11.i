...
void dht11_read(uint8_t *tem, uint8_t *hum){
    ...
    LATBbits.LATB3 = 0;
    _delay((unsigned long)((18)*(32000000L/4000.0)));
    TRISBbits.TRISB3 = 1;

    _delay((unsigned long)((22)*(32000000L/4000000.0)));

    dht_in = PORTBbits.RB3;
    ...
    _delay((unsigned long)((80)*(32000000L/4000000.0)));
    dht_in = PORTBbits.RB3;
    if(!dht_in){
        GlobalErr=2;
...
uint8_t leer_dht_dat(){
    ...
    for (i=0; i< 8; i++) {
        ...
        _delay((unsigned long)((30)*(32000000L/4000000.0)));
        if (PORTBbits.RB3==1)
        {
            result |=(1<<(7-i));
        }
