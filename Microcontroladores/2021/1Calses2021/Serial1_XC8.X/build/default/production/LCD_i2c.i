...
void Send_D7_D4(int8 address,int8 nibble){
   ...
   if((nibble & 8)==8) datos= datos|128; else datos = datos&~128;
      _delay((unsigned long)((60)*(32000000L/4000000.0)));
   if(address)
      datos= datos |1;
   else
     datos = datos &~1;
   ...
   Write_PCF( datos | 4);
   _delay((unsigned long)((2)*(32000000L/4000000.0)));
   Write_PCF( datos & ~4);
}
...
void lcd_init(void){
   ...
   _delay((unsigned long)((35)*(32000000L/4000.0)));
...
void lcd_putc(unsigned char c){
    switch(c){
        case '\f':
            lcd_send_byte(0,1);
            _delay((unsigned long)((2)*(32000000L/4000.0)));
            g_LcdX = 0;
            g_LcdY = 0;
            _delay((unsigned long)((2)*(32000000L/4000.0)));
            break;
