...
void SoftWareUart_Init()
{
  ...
  TRISCbits.TRISC6=1;
  LATCbits.LATC5=1;
 _delay((unsigned long)((((1000000/9600)))*(32000000/4000000.0)));
}
...
void Software_UART_Write(unsigned char Data)
{
  ...
  for (mask=0x01;mask!=0;mask=mask<<1)
   {
    if(Data&mask) LATCbits.LATC5 = 1;
    else LATCbits.LATC5 = 0;
  _delay((unsigned long)(((((1000000/9600)) - (4*16/32)))*(32000000/4000000.0)));
  }
  LATCbits.LATC5 = 1;
  _delay((unsigned long)((((1000000/9600)))*(32000000/4000000.0)));
}
...
unsigned char Software_UART_Read ()
{
 ...
 while(PORTCbits.RC6==1);
  _delay((unsigned long)(((((1000000/9600))/2))*(32000000/4000000.0)));
  for(mask=0x01;mask!=0;mask=mask<<1)
  {
    _delay((unsigned long)(((((1000000/9600)) - (4*18/32)))*(32000000/4000000.0)));
    if(PORTCbits.RC6)Data=Data|mask;
  }
  _delay((unsigned long)((((1000000/9600)))*(32000000/4000000.0)));
  return Data;
}
