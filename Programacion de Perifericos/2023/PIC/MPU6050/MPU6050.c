...
//void LDByteReadI2C(unsigned char mpu,unsigned char addr,unsigned char &cmd){
   i2c_start(); 
   //i2c_write(MPU6050_ADDRESS);
   i2c_write(mpu);
   i2c_write(addr);
...
void MPU6050_Test(){
   ...
   data=i2c_read(0);
   i2c_stop();*/
   //Printf(lcd_putc, "\f0x%x", x1);
   
   //delay_ms(1000);
   data=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_WHO_AM_I, data);
   //data=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_WHO_AM_I);

   if(data == 0x68){
      printf("\fTest Passed,\nMPU Addr: 0x%x", data);
   }else{
      printf("\fERROR: I2C Read\nTest Failed, Stopping");
      //while(true){}   
   }
}
...
void MPU6050_TEMP(float &t){
   ...
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_H,x1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_L,x2);
   
   //x1 = LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_H,x1);
   //x2 = LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_L,x2);
   //x1 = LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_H);
   //x2 = LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_TEMP_OUT_L);
   
   /*i2c_start(); 
   i2c_write(MPU6050_ADDRESS);
   i2c_write(MPU6050_RA_TEMP_OUT_H);
   i2c_start(); 
   i2c_write(MPU6050_R);
   x1=i2c_read(1);//lee y envia un ACK
   x2=i2c_read(0);//Lee y no envia un ACK
   i2c_stop();*/
   delay_ms(1);
...
void MPU6050_GYRO(int16 &x,int16 &y,int16 &z){
   ...
   x1=x2=y1=y2=z1=z2=0;
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_XOUT_H,x1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_XOUT_L,x2);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_YOUT_H,y1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_YOUT_L,y2);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_ZOUT_H,z1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_ZOUT_L,z2);
   
   /*x1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_XOUT_H,x1);
   x2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_XOUT_L,x2);
   y1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_YOUT_H,y1);
   y2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_YOUT_L,y2);
   z1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_ZOUT_H,z1);
   z2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_GYRO_ZOUT_L,z2);*/
   ...
   i2c_start(); 
   i2c_write(MPU6050_ADDRESS);
   i2c_write(MPU6050_RA_GYRO_YOUT_H );
   i2c_start();
   i2c_write(MPU6050_R);
   y1=i2c_read(1);//lee y envia un ACK
   y2=i2c_read(0);//Lee y no envia un ACK
   i2c_stop();
   delay_ms(1);
   ...
   i2c_start();
   i2c_write(MPU6050_R);
   z1=i2c_read(1);//lee y envia un ACK
   z2=i2c_read(0);//Lee y no envia un ACK
   i2c_stop();*/
...
void MPU6050_ACCEL(int16 &x,int16 &y,int16 &z){
   ...
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_H,x1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_L,x2);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_H,y1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_L,y2);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_H,z1);
   LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_L,z2);
   
   /*x1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_H,x1);
   x2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_XOUT_L,x2);
   y1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_H,y1);
   y2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_YOUT_L,y2);
   z1=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_H,z1);
   z2=LDByteReadI2C(MPU6050_ADDRESS,MPU6050_RA_ACCEL_ZOUT_L,z2);*/
